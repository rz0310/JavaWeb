...
<div class="grzxbj">
    <div class="selfinfo center">
        ...
        <div class="rtcont fr">
            ...
            <%
                ArrayList<Bill> bills = (ArrayList<Bill>) request.getSession().getAttribute("Bills");
                for (Bill bill: bills) {
            %>
            <div class="ddxq">
                <div class="ddspt fl"><img src="./image/gwc_xiaomi6.jpg" alt=""></div>
                <div class="ddbh fl">订单号:<%=bill.getId()%></div>
                <div class="ztxx fr">
                    <ul>
                        <li><%=bill.getStatus()%></li>
                        <li><%=bill.getMoney()%></li>
                        <li><%=bill.getDate()%></li>
                        <li>
                            <a href=<%="ShowDelInfo?billId=" + bill.getId()%>>订单详情></a>
                        </li>
                        <div class="clear"></div>
                    </ul>
                </div>
