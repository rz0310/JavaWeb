			...
			<form action="BillAddServlet" method="post">
				...
				<div>
					<label for="billPrice">商品单价：</label> <input type="text"
						name="billPrice" id="billPrice" required /> <span>*请输入商品单价</span>

				</div>
				<div>
					<label for="billNum">商品数量：</label> <input type="text"
						name="billNum" id="billNum" required /> <span>*请输入大于0的正自然数，小数点后保留2位</span>
				</div>
				<div>
					<label for="billMoney">总金额：</label> <input type="text" name="billMoney"
						id="billMoney" required /> <span>*请输入大于0的正自然数，小数点后保留2位</span>
				</div>
				<div>
					<label for="billDate">创建时间：</label> <input type="text" name="billDate"
						id="billDate" required /> <span>*请输入下单时间</span>
				</div>
				<div>
