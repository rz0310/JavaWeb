        ...
        <div class="providerAdd">
            <form action="UserUpdateServlet" method="post">
                ...
                <div>
                    ...
                    <input type="text" name="userName" id="userName" placeholder="leijun"/>
                    <span >*</span>
                </div>
                <div>
                    <label for="userpassword">用户密码：</label>
                    <input type="text" name="userPassword" id="userpassword" placeholder="123456"/>
                    <span>*</span>
                ...
                <div>
                    ...
                    <input type="text" name="userSign" id="userSign" placeholder="Are you OK?"/>
                    <span >*</span>
                </div>
                <div>
