...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="ProUpdateServlet" method="post">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div class="">
                    <label for="providerId">供应商编码：</label>
                    <input type="text" name="providerId" id="providerId" value="<%=id%>" readonly/>
                    <span>*</span>
                </div>
                <div>
                    <label for="providerName">供应商名称：</label>
                    <input type="text" name="providerName" id="providerName" placeholder="<%=name%>"/>
                    <span >*</span>
                </div>
                <div>
                    <label for="people">联系人：</label>
                    <input type="text" name="people" id="people" placeholder="<%=conn%>"/>
                    <span>*</span>
                ...
                <div>
                    ...
                    <input type="text" name="address" id="address" placeholder="<%=add%>"/>
                    <span></span>
                ...
                <div>
                    ...
                    <input type="text" name="describe" id="describe" placeholder="<%=desc%>"/>
                    <span></span>
