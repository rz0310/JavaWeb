...
<%--<%@include file="show.jsp"%>&lt;%&ndash;指令元素：页面编译的时候才引入，发送请求的时候真正引入外部文件&ndash;%&gt;--%>
<html lang="en">
  <head>
    <title>$Title$</title>
  </head>
  ...
  1111111
    <%--<%--%>
       <%--out.print(1/0);//错误--%>
    <%--%>--%>
  <%--<jsp:include page="show.jsp">:动作元素：在本页面运行时直接引入show.jsp--%>
  ...
  <%--<jsp:param name="111" value="222"/>:将本页面的参数传递到要跳转的页面--%>
    <%--<jsp:forward page="show.jsp">--%><%--跳转页面：请求转发--%>
